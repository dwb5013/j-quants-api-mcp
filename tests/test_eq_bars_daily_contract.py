...
class EqBarsDailyContractTest(unittest.TestCase):
    def test_eq_bars_daily_uses_official_path_and_params(self) -> None:
    ...
    def test_eq_bars_daily_tool_schema_uses_official_query_names(self) -> None:
        schema = mcp._tool_manager._tools["eq-bars-daily"].parameters
